														...
														<div class="box-img-hover">
															...
															<div class="mask-icon">
																...
																<security:authorize access="isAnonymous()">
																	<a class="cart"
																		href="<c:url value='/dang-nhap'/>">Add
																		to Cart</a>
																</security:authorize>
															</div>
														</div>
												...
												<div class="row">
													...
													<div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
														<div class="why-text full-width">
															...
															<p>${item.detail}</p>
															<security:authorize access="isAuthenticated()">
								 								<a class="btn hvr-hover addtocart" onclick="addtocart()" data-id="${item.id}"
																	href="<c:url value='/them-gio-hang/${item.id}'/>"
																	>Add to Cart</a> 
															</security:authorize>
															<security:authorize access="isAnonymous()">
																<a class="btn hvr-hover" href="<c:url value='/dang-nhap'/>">Add to Cart</a>
															</security:authorize>
														</div>
													</div>
												</div>
