...
<c:url var="newAPI" value="/api/slider" />
<c:url var="newURL" value="/quan-tri/slider/tat-ca-slider" />
<!DOCTYPE html>
<html>
<head>
...
<div class="main-container">
	<form action="<c:url value='/quan-tri/slider/tat-ca-slider'/>" id="formSubmit" method="get">
			...
			<div class="card-box mb-30">
				<div class="pd-20">
					...
					<div class="col-md-2 col-sm-12">	
						...
						<c:url var="createNewURL" value="/quan-tri/slider/them" />
						<a flag="info" class="dt-button buttons-colvis btn btn-white btn-primary btn-bold"
							data-toggle="tooltip" title='Thêm slider'
							href='${createNewURL}'> 
							<span> <i class="fa fa-plus-circle bigger-110 purple"></i></span>
						</a>
						<button id="btnDelete" type="button" onclick="warningBeforeDelete()"
							class="dt-button buttons-html5 btn btn-white btn-primary btn-bold"
							data-toggle="tooltip" title='Xóa slider'>
								...
								<td>
									<!-- <div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list"> -->
											<c:url var="updateNewURL" value="/quan-tri/slider/chinh-sua">
