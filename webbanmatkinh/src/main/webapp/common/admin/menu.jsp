			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					<%-- <li class="dropdown">
						...
						<ul class="submenu">
							<li><a href="<c:url value="/quan-tri/san-pham/danh-sach?page=1&limit=5"/>">Product</a></li>
							<li><a href="<c:url value="/quan-tri/the-loai/tat-ca-the-loai?page=1&limit=5"/>">Category</a></li>
