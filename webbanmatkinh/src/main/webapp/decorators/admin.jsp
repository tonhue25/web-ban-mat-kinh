...
<head>
	...
	<link rel="icon" type="image/png" sizes="32x32" href="<c:url value='/template/admin/vendors/images/favicon-32x32.png'/>">
	<link rel="icon" type="image/png" sizes="16x16" href="<c:url value='/template/admin/vendors/images/favicon-16x16.png'/>">
